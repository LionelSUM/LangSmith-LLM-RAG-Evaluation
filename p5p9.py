...
print("\n\n")
print(retrieval_chain_rag_fusion)
print("\n\n")
...
generate_queries_step_back = prompt | ChatOpenAI(model_name="qwen2.5-14b-instruct", temperature=0) | StrOutputParser()
question = "What is task decomposition for LLM agents?"
...
generate_docs_for_retrieval = (
    prompt_hyde | ChatOpenAI(model_name="qwen2.5-14b-instruct", temperature=0) | StrOutputParser()
)
